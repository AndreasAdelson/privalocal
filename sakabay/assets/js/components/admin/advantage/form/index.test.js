...
import AdvantageForm from './index';
...
describe('Create or edit an advantage entity', () => {
  beforeEach(() => {
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    await AdvantageForm.created.bind(wrapper.vm)();
    expect(wrapper.vm.formFields.message).toEqual('message test');
