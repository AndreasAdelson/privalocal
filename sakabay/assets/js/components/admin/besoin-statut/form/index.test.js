...
import BesoinStatutForm from './index';
...
describe('Create or edit an besoin statut entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(BesoinStatutForm, {
      i18n,
      localVue,
    });
  });
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    await BesoinStatutForm.created.bind(wrapper.vm)();
