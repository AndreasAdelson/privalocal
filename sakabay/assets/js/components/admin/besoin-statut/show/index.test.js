...
import BesoinStatutShow from './index.vue';
...
describe('Show an besoin statut entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(BesoinStatutShow, {
      i18n,
      localVue,
    });
  });
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    wrapper.vm.besoinStatutId = 10;
    wrapper.vm.loading = true;
    await BesoinStatutShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.besoinStatut).toEqual({name: 'name test'});
