...
import CategoryShow from './index';
...
describe('Show a category entity', () => {
  beforeEach(() => {
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    wrapper.vm.categoryId = 10;
    wrapper.vm.loading = true;
    await CategoryShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.category).toEqual({name: 'name test'});
