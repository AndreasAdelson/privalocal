...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    await CityShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.city).toEqual({name: 'name test'});
