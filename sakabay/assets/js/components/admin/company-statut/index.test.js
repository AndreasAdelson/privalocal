...
import CompanyStatutIndex from './index';
...
describe('CompanyStatut entity index', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(CompanyStatutIndex, {
      i18n,
      localVue,
    });
  });
...
describe('methods test', () => {
  it('refreshData() test', () => {
    ...
    expect(spyOnGet).toHaveBeenCalledWith('/api/admin/company-statuts',expectedData);
  });
