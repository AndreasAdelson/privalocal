...
import CompanyStatutShow from './index';
...
describe('Show a companyStatut entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(CompanyStatutShow, {
      i18n,
      localVue,
    });
  });
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    wrapper.vm.companyStatutId = 10;
    wrapper.vm.loading = true;
    await CompanyStatutShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.companyStatut).toEqual({name: 'name test'});
