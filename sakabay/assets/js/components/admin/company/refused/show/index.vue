<template>
  <div class="skb-body container ">
    ...
    <div v-else-if="!loading && company.company_statut &&company.company_statut.code === 'VAL'">
      <div class="row pt-5">
        <div class="col">
          <p class="text-center">
    ...
    <div v-else-if="!loading && company.company_statut && company.company_statut.code === 'ENC'">
      <div class="row pt-5">
        <div class="col">
          <p class="text-center">
    ...
    <div v-else-if="!loading && company.company_statut && company.company_statut.code === 'REF'">
      <div
        v-if="canEdit"
        class="row mt-3 "
      >
