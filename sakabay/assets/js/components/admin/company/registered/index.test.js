...
import RegisteredCompanyIndex from './index';
...
describe('RegisteredCompany entity index', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(RegisteredCompanyIndex, {
      i18n,
      localVue,
    });
  });
    ...
    axios.get.mockImplementationOnce(() => {
      return Promise.resolve({
        data: [{
          ...
          dt_created: '20/07/2021 17:00:00'
        }],
        headers: { 'x-total-count': 4 }
      });
    });
