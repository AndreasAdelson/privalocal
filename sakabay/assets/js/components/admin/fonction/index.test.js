...
import FonctionIndex from './index';
...
describe('Fonction entity index', () => {
  beforeEach(() => {
...
describe('methods test', () => {
  it('refreshData() test', () => {
    wrapper.vm.filterFields = 'description';
    ...
    const expectedData = {
      params: {currentPage: 1, filter: 'testfilter', filterFields: 'description', perPage: 1, sortBy: 'still a test', sortDesc: false}
    };
    wrapper.vm.refreshData();
    expect(spyOnGet).toHaveBeenCalledWith('/api/admin/fonctions',expectedData);
  });
