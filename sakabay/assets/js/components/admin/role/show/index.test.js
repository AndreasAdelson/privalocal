...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    await RoleShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.role).toEqual({name: 'name test'});
