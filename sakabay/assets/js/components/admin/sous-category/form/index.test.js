...
import SousCategoryForm from './index';
...
describe('Create or edit a company entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(SousCategoryForm, {
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    await SousCategoryForm.created.bind(wrapper.vm)();
    expect(wrapper.vm.formFields.name).toEqual('name test');
    expect(wrapper.vm.loading).toEqual(false);
    expect(wrapper.vm.category).toEqual([{name: 'category name test'}]);
  });
