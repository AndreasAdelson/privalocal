...
import SousCategoryIndex from './index';
...
describe('SousCategory entity index', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(SousCategoryIndex, {
      i18n,
      localVue,
    });
  });
...
describe('methods test', () => {
  it('refreshData() test', () => {
    ...
    expect(spyOnGet).toHaveBeenCalledWith('/api/admin/sous-categories',expectedData);
  });
