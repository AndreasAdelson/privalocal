...
import SubscriptionStatusIndex from './index';
...
describe('SubscriptionStatus entity index', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(SubscriptionStatusIndex, {
      i18n,
      localVue,
    });
  });
...
describe('methods test', () => {
  it('refreshData() test', () => {
    ...
    expect(spyOnGet).toHaveBeenCalledWith('/api/admin/subscription-status',expectedData);
  });
