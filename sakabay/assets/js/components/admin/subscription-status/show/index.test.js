...
import SubscriptionStatusShow from './index';
...
describe('Show a subscriptionStatus entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(SubscriptionStatusShow, {
      i18n,
      localVue,
    });
  });
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    wrapper.vm.subscriptionStatusId = 10;
    wrapper.vm.loading = true;
    await SubscriptionStatusShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.subscriptionStatus).toEqual({
      name: 'name test',
      code: 'test code'
    });
