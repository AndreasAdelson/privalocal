...
import SubscriptionShow from './index';
...
describe('Show a subscription entity', () => {
  beforeEach(() => {
    ...
    wrapper = shallow(SubscriptionShow, {
      i18n,
      localVue,
    });
  });
...
describe('created test', () => {
  it('creates with id', async() => {
    ...
    .mockImplementationOnce(() => Promise.resolve({data: {
      name: 'name test',
      advantages: [{message: 'advantage message test'}],
      price: 10,
      code: 'test code'
    }}));
    wrapper.vm.subscriptionId = 10;
    wrapper.vm.loading = true;
    await SubscriptionShow.created.bind(wrapper.vm)();
    expect(wrapper.vm.subscription).toEqual({
      name: 'name test',
      advantages: [{message: 'advantage message test'}],
      price: 10,
      code: 'test code'
